...
authenticationRouter.post("/signup", auth_joi_middleware_1.signUpIsValid, authenticationController_1.createSignUp);
authenticationRouter.post("/signin", auth_joi_middleware_1.signInIsValid, authenticationController_1.createSignIn);
